...
function initRandomControls() {
  ...
  function openDisplayColumnSidebar() {
    ...
    if (displayColumnSidebarDescriptionElement) {
      displayColumnSidebarDescriptionElement.textContent = state.session ? "\u0412\u044B\u0431\u0435\u0440\u0438\u0442\u0435 \u043A\u043E\u043B\u043E\u043D\u043A\u0443 \u0438\u0437 Excel, \u043A\u043E\u0442\u043E\u0440\u0430\u044F \u0431\u0443\u0434\u0435\u0442 \u043E\u0442\u043E\u0431\u0440\u0430\u0436\u0430\u0442\u044C\u0441\u044F \u0443 \u043F\u043E\u0431\u0435\u0434\u0438\u0442\u0435\u043B\u0435\u0439 \u043D\u0430 \u044D\u043A\u0440\u0430\u043D\u0435 \u0438 \u0432 \u0438\u0441\u0442\u043E\u0440\u0438\u0438." : "\u0421\u043D\u0430\u0447\u0430\u043B\u0430 \u0432\u044B\u0431\u0435\u0440\u0438\u0442\u0435 Excel-\u0444\u0430\u0439\u043B. \u041F\u043E\u0441\u043B\u0435 \u0437\u0430\u0433\u0440\u0443\u0437\u043A\u0438 \u043D\u0438\u0436\u0435 \u043F\u043E\u044F\u0432\u0438\u0442\u0441\u044F \u043F\u043E\u043B\u0435 \u0434\u043B\u044F \u0440\u043E\u0437\u044B\u0433\u0440\u044B\u0448\u0430.";
    }
    if (displayColumnImportButtonElement) {
      displayColumnImportButtonElement.disabled = state.isImporting;
      displayColumnImportButtonElement.textContent = state.session ? "\u0412\u044B\u0431\u0440\u0430\u0442\u044C \u0434\u0440\u0443\u0433\u043E\u0439 \u0444\u0430\u0439\u043B" : "\u0412\u044B\u0431\u0440\u0430\u0442\u044C \u0444\u0430\u0439\u043B";
    }
    if (displayColumnSidebarFileElement) {
      displayColumnSidebarFileElement.textContent = state.session?.source?.originalName ? `\u0424\u0430\u0439\u043B: ${state.session.source.originalName}` : "\u0424\u0430\u0439\u043B \u0435\u0449\u0451 \u043D\u0435 \u0432\u044B\u0431\u0440\u0430\u043D";
    }
    ...
    if (displayColumnSidebarNoteElement) {
      if (state.session) {
        ...
        displayColumnSidebarNoteElement.textContent = "\u0417\u0430\u0433\u0440\u0443\u0437\u0438\u0442\u0435 Excel-\u0444\u0430\u0439\u043B \u0441 \u043D\u0443\u0436\u043D\u043E\u0439 \u0441\u0442\u0440\u0443\u043A\u0442\u0443\u0440\u043E\u0439. \u041F\u043E\u0441\u043B\u0435 \u044D\u0442\u043E\u0433\u043E \u043C\u043E\u0436\u043D\u043E \u0431\u0443\u0434\u0435\u0442 \u0432\u044B\u0431\u0440\u0430\u0442\u044C \u043A\u043E\u043B\u043E\u043D\u043A\u0443 \u0434\u043B\u044F \u043E\u0442\u043E\u0431\u0440\u0430\u0436\u0435\u043D\u0438\u044F \u043F\u043E\u0431\u0435\u0434\u0438\u0442\u0435\u043B\u0435\u0439.";
      }
    }
    if (state.session) {
  ...
  function syncSidebarActions() {
    if (!undoDrawButtonElement || !resetExclusionsButtonElement || !resetExclusionsDescriptionElement) {
      return;
    }
    ...
    if (!state.session) {
      ...
      resetExclusionsDescriptionElement.textContent = "\u0421\u043D\u0430\u0447\u0430\u043B\u0430 \u0437\u0430\u0433\u0440\u0443\u0437\u0438\u0442\u0435 \u0444\u0430\u0439\u043B. \u041F\u043E\u0441\u043B\u0435 \u044D\u0442\u043E\u0433\u043E \u0437\u0434\u0435\u0441\u044C \u043C\u043E\u0436\u043D\u043E \u043E\u0442\u043C\u0435\u043D\u0438\u0442\u044C \u043F\u043E\u0441\u043B\u0435\u0434\u043D\u0438\u0439 \u0440\u043E\u0437\u044B\u0433\u0440\u044B\u0448 \u0438\u043B\u0438 \u043F\u043E\u043B\u043D\u043E\u0441\u0442\u044C\u044E \u043E\u0447\u0438\u0441\u0442\u0438\u0442\u044C \u0432\u0441\u0451, \u0432\u043A\u043B\u044E\u0447\u0430\u044F \u0442\u0435\u043A\u0443\u0449\u0438\u0439 \u0444\u0430\u0439\u043B.";
      return;
    }
    ...
    resetExclusionsButtonElement.textContent = winnerHistoryCount > 0 || globalWinnerCount > 0 ? `\u041E\u0447\u0438\u0441\u0442\u0438\u0442\u044C \u0432\u0441\u0435 (${Math.max(winnerHistoryCount, globalWinnerCount)})` : "\u041E\u0447\u0438\u0441\u0442\u0438\u0442\u044C \u0432\u0441\u0435";
    if (!canUndo && winnerHistoryCount === 0 && globalWinnerCount === 0) {
      resetExclusionsDescriptionElement.textContent = "\xAB\u041E\u0447\u0438\u0441\u0442\u0438\u0442\u044C \u0432\u0441\u0435\xBB \u0443\u0434\u0430\u043B\u0438\u0442 \u0442\u0435\u043A\u0443\u0449\u0438\u0439 \u0444\u0430\u0439\u043B, \u043E\u0447\u0438\u0441\u0442\u0438\u0442 blacklist \u0438 \u0432\u0435\u0440\u043D\u0451\u0442 \u044D\u043A\u0440\u0430\u043D \u0432 \u043F\u0443\u0441\u0442\u043E\u0435 \u0441\u043E\u0441\u0442\u043E\u044F\u043D\u0438\u0435.";
      return;
    }
    const details = [];
    if (canUndo && lastDraw) {
      const drawWinnerCount = Array.isArray(lastDraw.winners) ? lastDraw.winners.length : lastDraw.winnersCount || 0;
      details.push(
        `\xAB\u041E\u0442\u043C\u0435\u043D\u0438\u0442\u044C\xBB \u0441\u043D\u0438\u043C\u0435\u0442 \u043F\u043E\u0441\u043B\u0435\u0434\u043D\u0438\u0439 \u0440\u043E\u0437\u044B\u0433\u0440\u044B\u0448 \u043D\u0430 ${drawWinnerCount} ${getWinnerWord(drawWinnerCount)}`
      );
    }
    if (winnerHistoryCount > 0 || globalWinnerCount > 0) {
      details.push(
        `\xAB\u041E\u0447\u0438\u0441\u0442\u0438\u0442\u044C \u0432\u0441\u0435\xBB \u0443\u0434\u0430\u043B\u0438\u0442 \u0438\u0441\u0442\u043E\u0440\u0438\u044E \u0444\u0430\u0439\u043B\u0430, \u043E\u0431\u0449\u0438\u0439 blacklist \u0438 \u0441\u0430\u043C \u0437\u0430\u0433\u0440\u0443\u0436\u0435\u043D\u043D\u044B\u0439 Excel`
      );
    }
    if (excludedCount > 0) {
  ...
  function setImportingState(isImporting) {
    ...
    if (displayColumnImportButtonElement) {
      ...
      displayColumnImportButtonElement.textContent = isImporting ? "\u0417\u0430\u0433\u0440\u0443\u0436\u0430\u0435\u043C \u0444\u0430\u0439\u043B\u2026" : state.session ? "\u0412\u044B\u0431\u0440\u0430\u0442\u044C \u0434\u0440\u0443\u0433\u043E\u0439 \u0444\u0430\u0439\u043B" : "\u0412\u044B\u0431\u0440\u0430\u0442\u044C \u0444\u0430\u0439\u043B";
    }
    syncToolbarActions();
    syncDrawAvailability();
  }
  ...
  function exportWinnerHistory() {
    ...
    const csvContent = [
      ["\u2116", "\u0414\u0430\u0442\u0430 \u0440\u043E\u0437\u044B\u0433\u0440\u044B\u0448\u0430", "\u041E\u0442\u043E\u0431\u0440\u0430\u0436\u0430\u0435\u043C\u043E\u0435 \u0437\u043D\u0430\u0447\u0435\u043D\u0438\u0435", "\u041A\u043B\u044E\u0447 \u0430\u043D\u0442\u0438\u0434\u0443\u0431\u043B\u044F", "\u0414\u043E\u043F\u043E\u043B\u043D\u0438\u0442\u0435\u043B\u044C\u043D\u043E"].map(buildCsvCell).join(";"),
      ...rows.map((row) => row.map(buildCsvCell).join(";"))
    ].join("\n");
    const safeFileBase = String(state.session?.source?.originalName || "winners").replace(/\.[^.]+$/, "").replace(/[^a-zA-Z0-9а-яА-ЯёЁ._-]+/g, "-").replace(/-+/g, "-").replace(/^-|-$/g, "");
    downloadFile(
  ...
  displayColumnSidebarElement?.addEventListener("keydown", async (event) => {
    ...
    if (event.target.closest(".select__trigger") || event.target.closest(".select__option") || event.target.closest("button")) {
      return;
    }
    event.preventDefault();
    await saveDisplayColumnSelection();
  ...
  function renderActionSelect() {
    ...
    actionSelectMountElement.querySelector(".select__input")?.addEventListener("change", async (event) => {
      ...
      if (event.target.value === "reset-exclusions") {
        state.isActionPending = true;
        setStatus2(statusElement, "\u041F\u043E\u043B\u043D\u043E\u0441\u0442\u044C\u044E \u043E\u0447\u0438\u0449\u0430\u0435\u043C \u0438\u0441\u0442\u043E\u0440\u0438\u044E, blacklist \u0438 \u0442\u0435\u043A\u0443\u0449\u0438\u0439 \u0444\u0430\u0439\u043B\u2026");
        try {
          await api.resetExclusions(state.session.id);
          state.session = null;
          state.draw = null;
          ...
          sessionId = "";
          drawId = "";
          setStatus2(statusElement, "\u0412\u0441\u0435 \u043E\u0447\u0438\u0449\u0435\u043D\u043E. \u0412\u043E\u0437\u0432\u0440\u0430\u0449\u0430\u0435\u043C\u0441\u044F \u043A \u043F\u0443\u0441\u0442\u043E\u0439 \u0441\u0442\u0440\u0430\u043D\u0438\u0446\u0435 \u043D\u0430\u0441\u0442\u0440\u043E\u0435\u043A.", "success");
          window.setTimeout(() => {
